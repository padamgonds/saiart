<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartyInsertUpdate.aspx.cs" Inherits="SaiArtLatest.PartyInsertUpdate" 
...
<script type="text/javascript">
    ...
    <div class="row margin_bdtl_hdr_row_resp">
        <div class="col-xs-12 col-sm-12 col-md-12 bid-detl align-hdn-uam">
            <span class="page-heading">Party Update</span>
        ...
        <div class="bid-detl-frm">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 bit-dtl-bg bid-detls-frm-adj"
                ...
                <div class="col-sm-7 col-sm-offset-2">
                    <center>
                        <asp:Button ID="btnSave" class="btn btn-primary" runat="server" Text="Update" OnClientClick="return validate();" OnClick="btn_submit_click" />
                        &nbsp; &nbsp;
