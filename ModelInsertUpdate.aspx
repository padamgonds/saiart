<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModelInsertUpdate.aspx.cs" Inherits="SaiArtLatest.ModelInsertUpdate" %>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 bit-dtl-bg bid-detls-frm-adj"
                ...
                <div class="form-group center-block">
                      <div class="form-group">
                        <asp:Label ID="Label1" class="col-sm-2 control-label userlabel margin-uam-lbl"
                            runat="server" Text="Model Size"></asp:Label>
                        <span class="asterisk_input asterisk_adj asterisk_adj_uam"></span>
                        <div class="col-sm-4">
                         <asp:TextBox ID="txtSize" class="form-control pull-left margin-uam-ddl" runat="server"
                ...
                <div class="col-sm-7 col-sm-offset-2">
                    <center>
                        <asp:Button ID="btnSave" class="btn btn-primary" runat="server" Text="Update" OnClientClick="return validate();" OnClick="btn_save_click" />
                        &nbsp; &nbsp;
